...
export function ExpertSection(props) {
	const group = useRef()
	const bulb = useRef()
	const { nodes, materials, animations } = useGLTF('./models/iconography/INCONOGRAPHY_Expert_v16.glb')
		...
		<group ref={group} {...props} dispose={null}>
			<group name='Scene'>
				<group name='bulb'>
					...
					<mesh name='BULB' castShadow receiveShadow geometry={nodes.BULB.geometry} material={materials['Hireco - White Glass.001']} position={[0, 0.11, 0]} scale={[0.13, 0.03, 0.13]}></mesh>
				</group>
...
useGLTF.preload('./models/iconography/INCONOGRAPHY_Expert_v16.glb')
